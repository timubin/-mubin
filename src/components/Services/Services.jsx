    ...
    <div className="services" id="services">
      ...
      <div className="awesome">
        ...
        <spane style={{paddingBottom:"10px"}}>
         ...
         Proficient in HTML, CSS, JavaScript, Bootstrap, Tailwind CSS, jQuery, React.js, PHP, Laravel,
        <br />
        WordPress, MySQL Database, Git, GitHub, VS Code, and Chrome DevTools,
          <br />
          I offer comprehensive expertise in full-stack web development.
        </spane>
